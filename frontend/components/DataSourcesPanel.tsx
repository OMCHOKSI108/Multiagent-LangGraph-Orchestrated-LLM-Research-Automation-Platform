...
const statusConfig = {
    ...
    pending: { icon: Loader2, color: 'text-gray-400 animate-spin' },
};
            ...
            {sourceList.length === 0 ? (
                ...
                <div className="space-y-2 max-h-48 overflow-y-auto">
                    {sourceList.map((source, idx) => {
                        ...
                        const statusColor = statusConfig[source.status]?.color || 'text-gray-400';

                        return (
                            <div
                                key={idx}
                                className="flex items-center justify-between py-1 px-2 bg-gray-900/50 rounded"
                            >
