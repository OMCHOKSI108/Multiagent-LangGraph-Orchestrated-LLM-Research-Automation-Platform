    ...
    >
      ...
      >
        <div className="flex items-center gap-2 min-w-0">
          <span className="flex-shrink-0" style={{ color: `var(${cfg.colorVar})` }}><BrainIcon className="w-5 h-5" /></span>
          <span
    ...
    <div className="flex flex-col h-full overflow-hidden">
      ...
      >
        <div className="flex items-center gap-2">
          <span style={{ color: 'var(--accent-violet)' }}><BrainIcon className="w-5 h-5" /></span>
